...
const GalleryScreen = (): React.JSX.Element => {
    ...
    const renderItem = ({ item, index }: { item: { id: number; uri: string }; index: number }) => (
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Modal statusBarTranslucent visible={isModalVisible} transparent animationType="fade">
                <View style={styles.modalContainer}>
                    <TouchableOpacity activeOpacity={0.8} onPress={closeModal} style={styles.closeButton}>
                        <Text style={{ color: Colors.white, fontSize: 30, fontWeight: '700' }}>X</Text>
                    </TouchableOpacity>
                    <Image
