...
import {ShopState} from '../store/shop/shopSlice.ts';


const ORDER_HISTORY_KEY = 'ORDER_HISTORY';

// Функция сохранения истории
export const saveOrderHistoryToStorage = async (orderHistory: ShopState['orderHistory']) => {
    try {
...
export const getOrderHistoryFromStorage = async (): Promise<ShopState['orderHistory']> => {
    try {
